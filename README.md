...
On the 30th of September, **SoulGirlJP** announced an upgrade to v354.5, rather than the previously stated v354.4, for "better performance in the loading of the characters". The upgrade to 64-bit is supposedly meant to give "more performance in every way", and players "will see a very big difference of performance, (and their) client will go faster no lagg at all \[sic\]". Sadly, this update was not without its own set of issues as well: along with the new client came several reports of Sality.AU worms. In spite of this, [**SoulGirlJP** maintains that](https://media.discordapp.net/attachments/731528944402300977/897332982313017374/unknown.png?width=460&height=670) they "never had that problem nor (they) ever seen this Sality", and that "only thing (they) modified is a plain ol \[sic\] dll that KMS uses and thats it" so players should simply "just exclude it in window defender \[sic\] the folder \[sic\]".  
