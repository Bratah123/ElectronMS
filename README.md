...
What this means is that ElectronMS is a more complete product than both [**SoulGirlJP**'s repository](https://github.com/SoulGirlJP/AzureV316), and [**Duck**'s fork](https://github.com/ARealDuck/AzureV316-Resoration-project) - albeit unlikely to have the Korean text in-game translated to English by its maintainers.  
Unlike the official open-source repository made available by **SoulGirlJP**, this is not an "abandoned" project, and will continue to receive support from its maintainers in the forseeable future. Lots of the code written in ElectronMS is also 2 years old, and therefore may contain poorly written code from when the developers were still new at coding/programming. This release is for educational purposes and preservation of Azure history and it's game.
