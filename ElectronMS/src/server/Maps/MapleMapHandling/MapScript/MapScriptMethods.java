package server.Maps.MapleMapHandling.MapScript;
...
import server.Events.EventManager.EventManager;
import server.LifeEntity.Npc.NpcScript.NPCScriptManager;
import server.LifeEntity.Npc.NpcScript.NPCTalk;
...
import client.Skills.VMatrix.MapleNodes.DirectionInfo;
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            case Ranmaru_Before: {
                if (c.getPlayer().getMap().getAllMonster().size() == 0) {
                    c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9421581), new Point(109, 123));
                    break;
                }
            }
            case pierre_Summon: {
            ...
            case sao_enterF01: {
                ...
                c.getPlayer().getMap().resetFully();
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390706), new Point(-615, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390706), new Point(-364, 336));
            ...
            case sao_enterF02: {
                ...
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390700), new Point(-454, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390700), new Point(-119, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390700), new Point(563, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390700), new Point(995, 336));
            ...
            case sao_enterF08: {
                ...
                c.getPlayer().getMap().resetFully();
                // c.getPlayer().getMap().startMapEffect("Floor 2.", 5120107);
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390701), new Point(-593, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390701), new Point(-205, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390701), new Point(207, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390701), new Point(614, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390701), new Point(1017, 336));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390701), new Point(842, 28));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390701), new Point(1218, -84));
                c.getPlayer().getMap().spawnMonsterOnGroundBelow(MapleLifeProvider.getMonster(9390701), new Point(768, -84));
    ...
    public static void startScript_User(final MapleClient c, String scriptName) {
        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            case Advanture_tuto00: {
                new Thread(() -> {
                    try {
                        ...
                        Thread.sleep(30);
                        c.getSession().writeAndFlush(UIPacket.getDirectionInfo("Effect/Direction3.img/effect/tuto/BalloonMsg0/0", 2100, 0, -120, 0, 0));
            ...
            case Advanture_tuto01: {
                new Thread(() -> {
                    try {
                        ...
                        Thread.sleep(3000);
                        c.getSession().writeAndFlush(UIPacket.getDirectionStatus(true));
                        c.getSession().writeAndFlush(UIPacket.getDirectionInfo("Effect/Direction3.img/effect/tuto/BalloonMsg0/3", 2100, 0, -120, 0, 0));
                        c.getSession().writeAndFlush(UIPacket.getDirectionInfo(1, 1800));
                        Thread.sleep(1800);
            ...
            case enter_101070000: {
                ...
                c.getSession().writeAndFlush(UIPacket.showInfo("The forest of fairies seems to materialize from nowhere as you exit the passage."));
                MapTimer.getInstance().schedule(() -> c.getSession().writeAndFlush(MainPacketCreator.showMapEffect("temaD/enter/fairyAcademy")), 2000);
                break;
            }
            ...
            case merTutorDrecotion20: {
                c.getSession().writeAndFlush(UIPacket.getDirectionStatus(true));
                c.getSession().writeAndFlush(UIPacket.IntroEnableUI(1));
                c.getSession().writeAndFlush(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/9", 2000, 0, -100, 1, 0));
                c.getSession().writeAndFlush(UIPacket.getDirectionInfo(1, 2000));
            ...
            case explorationPoint: {
                ...
                if (m != null && c.getPlayer().getLevel() >= m.level && c.getPlayer().getQuestStatus(m.questid) != 2) {
                    ...
                    for (int i = 0; i < m.maps.length; i++) {
                        ...
                        String substring = quest.substring(i + 6, i + 7);
                    ...
                    if (changedd) {
                        ...
                        c.getPlayer().dropMessage(-1, "Title " + m + " Explorer currently in progress");
                        c.getSession().writeAndFlush(MainPacketCreator.serverNotice(5, "Title " + m + " Explorer currently in progress " + number + "/" + m.maps.length + " completed"));
                    }
                }
                break;
            }
		 ...
		 * break; }
            ...
            case PTjob3M2: {
                if (c.getPlayer().getQuestStatus(25111) == 1) {
                    ...
                    c.getSession().writeAndFlush(UIPacket.getDirectionInfo(3, 2));
                    c.getSession().writeAndFlush(UIPacket.getDirectionStatus(true));
                    EventTimer.getInstance().schedule(() -> c.getSession().writeAndFlush(UIPacket.getDirectionInfo(3, 0)), 2500);
            ...
            case PTjob4M2: {
                ...
                if (c.getPlayer().getQuestStatus(25122) == 2 && c.getPlayer().getJob() == 2411) {
                    ...
                    EventTimer.getInstance().schedule(() -> c.getPlayer().dropMessage(-1, "Come inside me, Phantom!"), 8500);
            ...
            case q53251_enter: {
                ...
                EventTimer.getInstance().schedule(() -> NPCScriptManager.getInstance().start(c, 9270092, "q53251_enter"), 1000);
            ...
            case ds_tuto_3_1: {
                ...
                c.getSession().writeAndFlush(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/tuto/balloonMsg2/0", 2000, 0, -100, 1, 0));
                c.getSession().writeAndFlush(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/tuto/balloonMsg1/3", 2000, 0, -100, 1, 0));
                EventTimer.getInstance().schedule(() -> {
                    c.getSession().writeAndFlush(UIPacket.getDirectionInfo(3, 0));
                    ...
                    switch (directionInfo.fromString(s)) {
                        ...
                        case merTutorDrecotion05:
                            ...
                            EventTimer.getInstance().schedule(() -> {
                                c.getSession().writeAndFlush(UIPacket.getDirectionInfo(3, 2));
                                c.getSession().writeAndFlush(UIPacket.getDirectionStatus(true));
                                c.getSession().writeAndFlush(UIPacket.getDirectionInfo("Effect/Direction5.img/effect/mercedesInIce/merBalloon/5", 2000, 0, -100, 1, 0));
                            }, 2000);
                            EventTimer.getInstance().schedule(() -> {
                                c.getSession().writeAndFlush(UIPacket.IntroEnableUI(0));
                                c.getSession().writeAndFlush(MainPacketCreator.enableActions(c.getPlayer()));
