...
import server.Maps.MapleMapHandling.MaplePortal.PortalScript.PortalScriptManager;
...
public class MapleGenericPortal implements MaplePortal {
    ...
    public final void enterPortal(final MapleClient c) {
        if (getScriptName() != null) {
            ...
            c.getPlayer().changeMap(to, to.getPortal(getTarget()) == null ? to.getPortal(0) : Objects.requireNonNull(to.getPortal(getTarget()))); // late resolving
            // makes this
            // harder but
            // prevents us
            // from loading
