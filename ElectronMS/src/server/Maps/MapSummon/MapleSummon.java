...
public class MapleSummon extends AnimatedHinaMapObjectExtend {
    ...
    public MapleSummon(final MapleCharacter owner, final int skill, final Point pos,
        ...
        this.skillLevel = owner.getSummonLinkSkillLevel(Objects.requireNonNull(SkillFactory.getSkill(GameConstants.getLinkedAttackSkill(skill))));
        this.endTime = startTime + Objects.requireNonNull(SkillFactory.getSkill(skill)).getEffect(skillLevel).getDuration();
    ...
    public MapleSummon(MapleCharacter owner, int skill, int duration, Point pos, SummonMovementType movementType,
        ...
        this.skill = skill;
        int lkk = 0;
        if (owner.getSummonLinkSkillLevel(Objects.requireNonNull(SkillFactory.getSkill(GameConstants.getLinkedAttackSkill(skill)))) > 0) {
            lkk = owner.getSummonLinkSkillLevel(Objects.requireNonNull(SkillFactory.getSkill(GameConstants.getLinkedAttackSkill(skill))));
        }
    ...
    public final boolean isStaticSummon() {
        return !Objects.requireNonNull(SkillFactory.getSkill(getSkill())).getEffect(1).isStaticSummon();
    }
