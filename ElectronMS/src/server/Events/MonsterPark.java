...
public class MonsterPark {
    ...
    public String MonsterParkReword() {
        ...
        switch (day) {
            case 1:
                return "#b#e요일 보상 : #i2434745##z2434745##n#k";
            case 2:
                return "#b#e요일 보상 : #i2434746##z2434746##n#k";
            case 3:
                return "#b#e요일 보상 : #i2434747##z2434747##n#k";
            case 4:
                return "#b#e요일 보상 : #i2434748##z2434748##n#k";
            case 5:
                return "#b#e요일 보상 : #i2434749##z2434749##n#k";
            case 6:
                return "#b#e요일 보상 : #i2434750##z2434750##n#k";
            case 7:
                return "#b#e요일 보상 : #i2434751##z2434751##n#k";
        }
        return dayReword;
    }
