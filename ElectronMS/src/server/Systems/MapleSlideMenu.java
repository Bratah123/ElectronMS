...
public class MapleSlideMenu {
    ...
    public static class SlideMenu0 {
        ...
        public static String getSelectionInfo(MapleCharacter chr, int npcid) {
            ...
            if ((mapselect.length() == 0) || mapselect.toString().equals("")) {
                mapselect = new StringBuilder("#-1# There are no locations you can move to.");
            }
            if (npcid == 9201231) {
    ...
    public static class SlideMenu1 {
        ...
        public static String getSelectionInfo(MapleCharacter chr, int id) {
            StringBuilder mapselect = new StringBuilder();
            for (TimeGate gate : TimeGate.values()) {
                if ((chr.getQuestStatus(gate.getRequieredQuest()) == gate.getRequieredQuestState()) || gate.getRequieredQuest() == 0) {
                    mapselect.append("#").append(gate.getId()).append("#").append(gate.getName());
                }
            }
        ...
        public static int getDataInteger(int id) {
            return TimeGate.getById(id) != null ? Objects.requireNonNull(TimeGate.getById(id)).getMap() : TimeGate.YEAR_2099.getMap(); //Year 2099 as default
        }
    }
    ...
    public static class SlideMenu2 {
        ...
        public static int getDataInteger(int type) {
            return 0;
        }

        public static String getSelectionInfo(MapleCharacter player, int id) {
        return null;
        }
    }
    ...
    public static class SlideMenu4 {
        ...
        public static String getSelectionInfo() {
            StringBuilder buffselect = new StringBuilder();
            for (BuffMenu buffdata : BuffMenu.values()) {
                buffselect.append("#").append(buffdata.getId()).append("# ").append(buffdata.getName());
            }
            return buffselect.toString();
        }
    ...
    public static class SlideMenu5 {
        ...
        public static int getDataInteger(int id) {
            ...
            return Objects.requireNonNull(TownTeleport.getById(id)).getMap();
        }
    }
