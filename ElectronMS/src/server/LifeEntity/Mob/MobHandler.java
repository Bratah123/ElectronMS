...
public class MobHandler {
    ...
    public static void MoveMonster(final ReadingMaple rh, final MapleClient c, final MapleCharacter chr) {
        int oid = rh.readInt();
    ...
    public static void MobSkillDelayEnd(ReadingMaple slea, MapleCharacter chr) {
    ...
    public static void ObtacleAtomCollision(ReadingMaple rm, MapleCharacter chr) {
        int len = rm.readInt();
        for (int i = 0; i < len; i++) {
            int idx = rm.readInt();
            int SN = rm.readInt();
    ...
    public static void FriendlyDamage(final ReadingMaple rh, final MapleCharacter chr) {
    ...
    public static void HypnotizeDmg(final ReadingMaple slea, final MapleCharacter chr) {
    ...
    public static void MobNode(ReadingMaple slea, MapleCharacter chr) {
    ...
    public static void DisplayNode(ReadingMaple slea, MapleCharacter chr) {
        MapleMonster mob_from = chr.getMap().getMonsterByOid(slea.readInt());
        if (mob_from != null) {
