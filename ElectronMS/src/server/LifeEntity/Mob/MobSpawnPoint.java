...
import server.LifeEntity.Mob.MonsterEntity.MonsterListener;
import server.LifeEntity.Mob.MonsterEntity.MonsterSpawnEntry;
import server.Maps.MapleMapHandling.MapleMap;

public class MobSpawnPoint extends MonsterSpawnEntry {
    ...
    public MobSpawnPoint(final MapleMonster monster, final Point pos, final int mobTime, final String msg) {
