...
import server.LifeEntity.Mob.BossEntity.FairyDust;
...
public class MobSkill {
    ...
    public void setMobSkillDelay(MapleCharacter chr, MapleMonster monster, int s, short option) {
        ...
        chr.getClient().sendPacket(MobPacket.MobSkillDelay(monster.getObjectId(), skillId, skillLevel, skillAfter, option, null));
    }
                ...
                switch (skillLevel) {
                    ...
                    case 7:
                        ...
                        if (fieldLucid.getId() == 450004150) {
                            ...
                            fieldLucid.broadcastMessage(BossPacket.createDragon(2, createPosX, posY, createPosX, createPosY, isLeft));
                        }
                        break;
                    case 8:
