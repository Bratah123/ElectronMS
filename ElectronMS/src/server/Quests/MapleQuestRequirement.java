...
class MapleQuestRequirement implements Serializable {
    ...
    private List<Short> jobs = new LinkedList<>();
    private List<Integer> fieldEnter = new LinkedList<>();
    private List<Integer> pets = new LinkedList<>();

    private Map<Integer, Boolean> skills = new LinkedHashMap<>();
    private Map<Integer, Byte> quests = new LinkedHashMap<>();
    private Map<Integer, Integer> items = new LinkedHashMap<>();
    private Map<Integer, Integer> mobs = new LinkedHashMap<>();
    ...
    protected MapleQuestRequirement(MapleQuest quest, ReadBin data) throws IOException {
        ...
        short mbmin = data.readShort();

        short charismaMin = data.readShort();
        short charmMin = data.readShort();
        short craftMin = data.readShort();
        short insightMin = data.readShort();
        short senseMin = data.readShort();
        short willMin = data.readShort();

        this.pop = data.readShort();
        short pettamenessmin = data.readShort();
