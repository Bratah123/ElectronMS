...
public class CaltechEval {
    ...
    private Vector<String> toTokens(String s) {
        ...
        while (i < s.length()) {
            ...
            if (nt > 0 && operator.toString().equals("atan") && c == '2') {
                ...
                nd++;
                if (nt > 0) {
                    tokenStrings.addElement(operator.toString());
                }
                nt = 0;
                operator = new StringBuilder();
                i++;
                ...
                if (nd > 0) {
                    tokenStrings.addElement(operand.toString());
                }
                nd = 0;
    ...
    public Vector<String> reduceTokens(Vector<String> tokens) {
        Double D = (double) 0;
        double leftValue, rightValue1, rightValue2;
