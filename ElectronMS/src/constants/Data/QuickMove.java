...
public class QuickMove {
    ...
    private static Map<Integer, List<QuickMoveEntry>> quickmoves = new HashMap<>();

    public static void load() {

        List<QuickMoveTownProperties> towns = new ArrayList<>();
	...
	towns.add(new QuickMoveTownProperties(101050000, true, true, true, true, true, true, true)); // 에우렐
        ...
        for (QuickMoveTownProperties qmtp : towns) {
            List<QuickMoveEntry> asd = new ArrayList<>();
            if (qmtp.a) {
