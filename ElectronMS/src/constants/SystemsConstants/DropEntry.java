...
public class DropEntry {
    ...
    public String getQuerySegment() {
        String sb = "(" +
                ...
                item_id +
                ", " +
                mindrop + // Minimum amount of items to drop at once
                ", " +
                maxdrop + // Maximum amount of items to drop at once
                ", " +
                0 + // Quest ID. Too lazy to even look at that
                ", " +
                chance + // Drop chance. Again, estimated
                ")";
        return sb;
    }
}
