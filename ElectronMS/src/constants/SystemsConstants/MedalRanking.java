...
public class MedalRanking {
    ...
    private static Map<String, List<MedalRankHolder>> rank = new HashMap<>();
    private static Map<String, ReentrantReadWriteLock> lock = new HashMap<>();
    ...
    public void sort() {
        for (Entry<String, List<MedalRankHolder>> l : rank.entrySet()) {
            ...
            try {
                Collections.sort(l.getValue(), (o1, o2) -> {
    ...
    public static class MedalRankHolder {
