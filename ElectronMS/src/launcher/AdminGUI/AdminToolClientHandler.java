...
public class AdminToolClientHandler {
    ...
    public static void updateServerInfo(IoSession session, int exp, int drop, int meso, String serverMessage) {
    ...
    public static void giveItem(IoSession session, String charName, int itemid, short quantity) {
    ...
    public static void giveHotTime(IoSession session, int itemid, short quantity) {
        for (ChannelServer cs : ChannelServer.getAllInstances()) {
    ...
    public static void banned(IoSession session, String charName) {
        MapleCharacter chr = null;
        for (ChannelServer cs : ChannelServer.getAllInstances()) {
            chr = cs.getPlayerStorage().getCharacterByName(charName);
            if (chr != null) {
    ...
    public static void giveMeso(IoSession session, String charName, long meso) {
        MapleCharacter chr = null;
        for (ChannelServer cs : ChannelServer.getAllInstances()) {
            chr = cs.getPlayerStorage().getCharacterByName(charName);
            if (chr != null) {
    ...
    public static void giveRC(IoSession session, String charName, int rc) {
        MapleCharacter chr = null;
        for (ChannelServer cs : ChannelServer.getAllInstances()) {
            chr = cs.getPlayerStorage().getCharacterByName(charName);
            if (chr != null) {
    ...
    public static void chatBlock(IoSession session, boolean block) {
    ...
    public static void userChatBlock(IoSession session, String charName, boolean block) {
        MapleCharacter chr = null;
        for (ChannelServer cs : ChannelServer.getAllInstances()) {
            chr = cs.getPlayerStorage().getCharacterByName(charName);
            if (chr != null) {
    ...
    public static void sendNotice(IoSession session, int type, String message) {
        byte[] packet = null;
        switch (type) {
            case 0:
    ...
    public static void WarpLoginServer(IoSession session) {
    ...
    public static void setGM(IoSession session, String charName) {
        MapleCharacter chr = null;
        for (ChannelServer cs : ChannelServer.getAllInstances()) {
            chr = cs.getPlayerStorage().getCharacterByName(charName);
            if (chr != null) {
    ...
    public static void discon(IoSession session, String charName) {
        MapleCharacter chr = null;
        for (ChannelServer cs : ChannelServer.getAllInstances()) {
            chr = cs.getPlayerStorage().getCharacterByName(charName);
            if (chr != null) {
