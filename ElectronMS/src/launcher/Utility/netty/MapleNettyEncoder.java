        ...
        if (client != null) {
            ...
            try {
                if (ServerConstants.showPackets) {
                    ...
                    final ReadingMaple slea = new ReadingMaple(new ByteStream(msg));
                    int packetheader = slea.readShort();
                    System.out.println("[Sand]" + SendPacketOpcode.getOpcodeName(packetheader) + " " + packetheader + " : " + HexTool.toString(msg));
                }
