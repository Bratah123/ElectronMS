...
public class ChracterTransfer implements Externalizable {
    ...
    public Object inventorys, skillmacro, keymap, savedlocation, famedcharacters, cashinventory, steelskills, storage,
            ...
            extendedSlots, cores;
    public final Map<MaplePlayerIdNamePair, Boolean> buddies = new LinkedHashMap<>();
    ...
    public Map<String, Integer> CustomValues2;
    public Map<String, Integer> CustomValues3;
