...
public class MapleNewCharJobType {
    ...
    public enum JobType {
        ...
        Illium(20, 15000, 410000002, true, false, false, false, false, false),
        ...
        public boolean hairColor, skinColor, faceMark, hat, bottom, cape;
         ...
         JobType(int type, int id, int map, boolean hairColor, boolean skinColor, boolean faceMark, boolean hat, boolean bottom, boolean cape) {
            this.type = type;
            this.id = id;
            this.map = map;
        ...
        public static ArrayList getDefaultFaceMark(JobType job) // demon, xenon
        {
        ...
        @SuppressWarnings("unchecked")
        public static ArrayList getDefaultBottom(JobType job) // Mihile, Evan, Aran
        {
            ArrayList list = new ArrayList();
            switch (job) {
                case Mihile: {
        ...
        @SuppressWarnings("unchecked")
        public static ArrayList getDefaultTop(JobType job) {
            ArrayList list = new ArrayList();
            switch (job) {
        ...
        @SuppressWarnings("unchecked")
        public static ArrayList getDefaultCape(JobType job) // Zero, Luminous, Phantom, Cygnus
        {
            ArrayList list = new ArrayList();
            switch (job) {
                case Cygnus: {
        ...
        @SuppressWarnings("unchecked")
        public static ArrayList getDefaultShoes(JobType job) {
            ArrayList list = new ArrayList();
            switch (job) {
                case UltimateAdventurer:
                case Adventurer:
        ...
        @SuppressWarnings("unchecked")
        public static ArrayList getDefaultWeapon(JobType job) {
            ArrayList list = new ArrayList();
            switch (job) {
                case UltimateAdventurer:
                case Adventurer:
        ...
        @SuppressWarnings("unchecked")
        public static ArrayList getDefaultShield(JobType job) {
            ArrayList list = new ArrayList();
            if (job == Demon) {
                list.add(1099001);
            }
