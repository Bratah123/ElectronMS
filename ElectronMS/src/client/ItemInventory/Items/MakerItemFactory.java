...
public class MakerItemFactory {
    ...
    private static Map<Integer, MakerItemFactory.MakerItemCreateEntry> recipes = new HashMap<>();
    ...
    public static MakerItemFactory.MakerItemCreateEntry getItemCreateEntry(int toCreate) {
        ...
        MapleData makerData = datasource.getData("ItemMake.img");
    ...
    public static class MakerItemCreateEntry {
        ...
        private List<Pair<Integer, Pair<Integer, Short>>> randomRewards = new ArrayList<>();
