...
public class MaplePet {
    ...
    public static final MaplePet loadFromDb(final int itemid, final int uniqueid, final short inventorypos) {
        ...
        try {
            ...
            for (String s : skillid) { //Call up the pet skill.
                ret.addSkillId(Integer.parseInt(s));
                ret.addSkillValue(Integer.parseInt(s));
            }
            rs.close();
            ps.close();
    ...
    public static MaplePet createPet(final int itemid, long expireDate) {
