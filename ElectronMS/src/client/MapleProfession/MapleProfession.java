...
public class MapleProfession {
    ...
    private List<Integer> availableRecipes = new ArrayList<>();
    ...
    public void addFatigue(int amount) {
        ...
        Objects.requireNonNull(chr.get()).updateSingleStat(PlayerStatList.FATIGUE, Math.max(0, Math.min(200, fatigue + amount)));
    }
