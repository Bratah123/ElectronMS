...
public class BuddyListHandler {
    ...
    private static CharacterIdNameBuddyCapacity getCharacterIdAndNameFromDatabase(final String name) {
        Connection con = null;
     ...
     * @throws SQLException
     */
    public static String getCharacterNameFromId(final int id) {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        String ret = null;
    ...
    public static void BuddyOperation(final ReadingMaple rh, final MapleClient c) {
