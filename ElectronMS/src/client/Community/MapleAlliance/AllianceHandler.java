...
public class AllianceHandler {
    ...
    public static void AllianceOperatopn(final ReadingMaple rh, final MapleClient c, boolean denied) {
    ...
    public static void DenyInvite(MapleClient c, final MapleGuild gs) {
