...
public class MapleUserTrade {
    ...
    public static void cancelTrade(final MapleUserTrade Localtrade) {
        Localtrade.cancel();
    ...
    public static void visitTrade(final MapleCharacter c1, final MapleCharacter c2, boolean isTrade, byte type) {
