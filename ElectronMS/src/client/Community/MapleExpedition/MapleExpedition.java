...
public class MapleExpedition {
    ...
    Map<Integer, MapleParty> parties = new LinkedHashMap<>();
    ...
    private final List<Integer> deadchars = new LinkedList<>();
    private int id;
    ...
    public boolean isContained(int num) {
        lock.lock();
        try {
            return parties.containsKey(num);
        } finally {
            lock.unlock();
        }
    }
