...
public class MapleAndroid {
    ...
    public static MapleAndroid loadFromDb(final int itemid, final int uniqueid) {
        Connection con = null; 
    ...
    public static MapleAndroid createAndroid(final int itemid) {
        ...
        defHair = Objects.requireNonNull(ItemInformation.getInstance().getAndroidBasicSettings(android)).getRandomHair();
        defFace = Objects.requireNonNull(ItemInformation.getInstance().getAndroidBasicSettings(android)).getRandomFace();
        Connection con = null; 
        PreparedStatement ps = null;
