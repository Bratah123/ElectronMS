package client.Skills.PhantomStealSkill;
...
public class PhantomStealSkill {
    ...
    List<StealSkillEntry> job1Skills = new ArrayList<>();
    List<StealSkillEntry> job2Skills = new ArrayList<>();
    List<StealSkillEntry> job3Skills = new ArrayList<>();
    List<StealSkillEntry> job4Skills = new ArrayList<>();
    List<StealSkillEntry> jobHyperSkills = new ArrayList<>();
    ...
    public void sortSkillEntrys(int index) {
        ...
        Comparator<StealSkillEntry> com = (o1, o2) -> {
