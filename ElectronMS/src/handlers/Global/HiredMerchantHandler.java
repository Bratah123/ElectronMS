...
import client.ItemInventory.Items.MerchItemPackage;
import tools.Pair;

public class HiredMerchantHandler {

    public static void UseHiredMerchant(final ReadingMaple rh, final MapleClient c) {
    ...
    public static void MerchantItemStore(final ReadingMaple rh, final MapleClient c) {
    ...
    public static boolean deletePackage(final int charid, int packageId) {
        Connection con;
        try {
            con = MYSQL.getConnection();
    ...
    public static MerchItemPackage loadItemFrom_Database(final int charid) {
        Connection con;
