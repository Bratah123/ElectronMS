...
public class PlayersHandler {
    ...
    public static void Note(final ReadingMaple rh, final MapleCharacter chr) {
    ...
    public static void GiveFame(final ReadingMaple rh, final MapleClient c, final MapleCharacter chr) {
    ...
    public static void UseDoor(final ReadingMaple rh, final MapleCharacter chr) {
    ...
    public static void UseMechDoor(final ReadingMaple rh, final MapleCharacter chr) {
    ...
    public static void TransformPlayer(final ReadingMaple rh, final MapleClient c, final MapleCharacter chr) {
        rh.skip(4); // Timestamp
        ...
        if (itemId == 2212000) {
            for (final MapleCharacter search_chr : c.getPlayer().getMap().getCharacters()) {
                if (search_chr.getName().toLowerCase().equals(target)) {
                    Objects.requireNonNull(ItemInformation.getInstance().getItemEffect(2210023)).applyTo(search_chr);
    ...
    public static void TouchRune(final ReadingMaple rh, final MapleCharacter chr) {
        rh.skip(4);
        int type = rh.readInt();
    ...
    public static void UseRune(final ReadingMaple rh, final MapleCharacter chr) {
        ...
        if (result == 1) {
            ...
            switch (chr.getTouchedRune()) {
                case 0: // Rune of Swiftness
                    effect = Objects.requireNonNull(SkillFactory.getSkill(80001427)).getEffect(1);
                    effect.applyTo(chr);
                    break;
                case 1: // Rune of Regeneration
                    effect = Objects.requireNonNull(SkillFactory.getSkill(80001428)).getEffect(1);
                    effect.applyTo(chr);
                    break;
                case 2: // Rune of Collapse
                    effect = Objects.requireNonNull(SkillFactory.getSkill(80001430)).getEffect(1);
                    effect.applyTo(chr);
                    break;
                case 3: // Rune of Doom
                    effect = Objects.requireNonNull(SkillFactory.getSkill(80001432)).getEffect(1);
                    effect.applyTo(chr);
                    break;
                case 4: // Rune of Thunder
                    effect = Objects.requireNonNull(SkillFactory.getSkill(80001752)).getEffect(1);
                    effect.applyTo(chr);
                    break;
                case 5: // Rune of the Earthquake
                    effect = Objects.requireNonNull(SkillFactory.getSkill(80001753)).getEffect(1);
                    effect.applyTo(chr);
                    break;
                case 6: // Rune of Darkness
                    effect = Objects.requireNonNull(SkillFactory.getSkill(80001754)).getEffect(1);
                    effect.applyTo(chr);
                    break;
                case 7: // Rune of Treasure
                    effect = Objects.requireNonNull(SkillFactory.getSkill(80001755)).getEffect(1);
                    effect.applyTo(chr);
                    break;
            }
    ...
    public static void HitReactor(final ReadingMaple rh, final MapleClient c) {
        final int oid = rh.readInt();
