...
import client.Stats.EquipStats.EquipStats;
...
public class DueyHandler {
    ...
    public static void saveDueyItems(int type, int pos, int quantity, int mesos, String name, MapleCharacter chr) {
        try {
            ...
            MapleInventory inventory = chr.getInventory(Objects.requireNonNull(MapleInventoryType.getByType((byte) type)));
            if (type == 1) {
