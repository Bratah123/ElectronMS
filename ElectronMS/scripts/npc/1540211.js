...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fs11##d<#fUI/UIWindow2.img/MobGage/Mob/9390711# :: #r봄온라인 지네#k>#d"+enter;
                msg += "<보스 보상 : #i4032101##fs14##r20개#r#fs11# >"+enter;
		msg += "<[제한 시간 :#k #r20분#k] #d일일 입장 횟수#k #d: #b"+cm.GetCount(bossname+"c", limit)+"회#k / #r"+limit+"회#k>#k"+enter;
