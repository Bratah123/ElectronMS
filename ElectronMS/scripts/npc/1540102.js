...
var bossid = 9390712; // 보스 몹 코드
var secondboss = 9999991; // (루시드, 스우만 적용. 2페 몹)
var startmap = 500000006; // 보스 맵
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fs11##d<#fUI/UIWindow2.img/MobGage/Mob/9390712# :: #r봄온라인 사신#k>#d"+enter;
                msg += "<보스 보상 : #i4032101##fs14##r30개#r#fs11# >"+enter;
