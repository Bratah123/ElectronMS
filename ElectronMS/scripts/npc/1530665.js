...
var bossid = 8920000; // Boss mob code
var startmap = 105200710; // Boss map
var bossname = "Chaos Queen" // In Hangul
var limit = 3; // Daily Admissions
var time = 50; // Time limit
//1135 48
var x = 34, y = 135; // Boss coordinates
/*------------------------------*/
function start() {
	status = -1;
	action(1, 0, 0);
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fs11##d<#i2591409# :: #r Chaos Queen#k>#d"+enter;
        msg += "Boss compensation : #i4001896#>"+enter;
