...
var bossid = 8900000; // Boss mob code
var startmap = 105200610; // Boss map
var bossname = "Chaos Pierre" // In Hangul
var limit = 3; // Daily Admissions
var time = 10; // Time limit
//1135 48
var x = 494, y = 551; // Boss coordinates
/*------------------------------*/
function start() {
	status = -1;
	action(1, 0, 0);
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fs11##d<#i2591391# :: #r Chaos Pierre#k>#d"+enter;
        msg += "Boss compensation : #i4001917#>"+enter;
