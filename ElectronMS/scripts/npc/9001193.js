...
function action(mode, type, selection) {
	...
	if (cm.getPlayer().getKeyValue("JusticeUnlock") != null) {
		if(mode == 0)
			...
			cm.sendGetText("\r\n#ePlease enter the name of the cash item \r\nto be acquired  #dJustice [600]#n\r\n#Cgray#- We can't refund items that were purchased inadvertently..\r\n*Warning* an unpopular nx equip could crash your \r\ncharacter. \r\nIf so, please contact a GM and if possible give them a clue on which caused it. #k\r\n\r\n#b [All Stats 650 ATT 200] Obtain a Cash item granted the attack.#k\r\n\r\n#rIf you don't know the exact name, enter the word included .");
	  } else {
	    cm.sendOk("Finish #rJustice Prequest~ #kbefore talking to me!");
        cm.dispose();
	  }
	} else if (status == 1) {
       ...
       if (cm.haveItem(4310034, 600)) {
            cm.gainItem(4310034, -600);
