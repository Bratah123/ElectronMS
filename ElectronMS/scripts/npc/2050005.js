...
var bossid = 8880200; // Boss mob code
var startmap = 221030910; // Boss mapBoss map
var bossname = "Omni-CLN" // In Hangul
var limit = 5; // Number of admissions allowed per day
var time = 30; // Time limit
//1135 48
var x = 536, y = 155; // Boss coordinates
/*------------------------------*/
function start() {
	status = -1;
	action(1, 0, 0);
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fs11##d<#i4032971# :: #r Earth Defense Force OMNI #k>#d"+enter;
        msg += "Boss compensation : #i4001911# >"+enter;
