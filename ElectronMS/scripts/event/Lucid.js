...
function playerEntry(eim, player) {
	...
	player.getClient().sendPacket(BossPacket.showSpineScreen(true, true, true, "Map/Effect3.img/BossLucid/Lucid4/0", "animation", 9000)); // Map/Effect3.img/BossLucid/Lucid/lusi <- important
